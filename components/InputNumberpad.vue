<template>
    <div ref="InputArea" class="input-area">
        <input v-model="inputValue" :class="inputFocused ? 'input-focused' : ''" @focus="focus" readonly />
        <transition name="number-pad">
            <div v-if="inputFocused" ref="NumberPad" :style="[
                ...
                <div v-if="allClear" @click="InputKey('모두 지우기')" v-wave class="keypad init"
